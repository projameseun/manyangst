...
int cStrcmp(const char* num, const char* num2)
{
...
int main()
{
	...
	}
	{
		...
		const char* str3 = "Worldj";

		std::cout << "같으면 : " << cStrcmp(str1, str2) << std::endl; 
		std::cout << "num이 작으면 : " << cStrcmp(str1, str3) << std::endl; 
		std::cout << "num이 크면 : " << cStrcmp(str3, str1) << std::endl;
	}
